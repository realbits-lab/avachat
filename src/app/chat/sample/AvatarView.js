...
import { loadVRMAnimation } from "@/src/lib/VRMAnimation/loadVRMAnimation";
import { VRMLookAtSmootherLoaderPlugin } from "@/src/lib/VRMLookAtSmootherLoaderPlugin/VRMLookAtSmootherLoaderPlugin";
...
function AvatarView({
  ...
  React.useEffect(() => {
    ...
    if (setAvatarExpressionFuncRef && setAvatarExpression) {
